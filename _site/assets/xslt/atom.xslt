...
<xsl:template match="/atom:feed">
	...
	<meta property="og:site_name" content="MLSS19 - Moscow, Russia">
	
	<meta property="article:author" content="https://www.facebook.com/mlss-skoltech">


	
	<!-- Twitter -->
	<meta name="twitter:card" content="summary">
	<meta name="twitter:site" content="mlss-skoltech">
	<meta name="twitter:creator" content="mlss-skoltech">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="" class="icon-tree"> MLSS19 - Moscow, Russia</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://0.0.0.0:8080/" title="MLSS19 - Moscow, Russia – Machine Learning Summer School 2019 - Moscow, Russia">
				<img src="/assets/img/logo.png" alt="MLSS19 - Moscow, Russia – Machine Learning Summer School 2019 - Moscow, Russia">
			</a>
      ...
      <div id="footer">
        <div class="row">
          <div class="medium-6 large-5 columns">
            <h5 class="shadow-black">About The MLSS</h5>
          ...
          <div class="small-6 medium-3 large-3 columns">
                ...
                <h5 class="shadow-black">Organizers</h5>
            ...
            <ul class="no-bullet shadow-black">
                ...
                <li class="services-newsletter" >
                  <a href="http://skoltech.ru/" target="_blank"  title="Skoltech">* Skolkovo Institute of Science & Technologh</a>
                </li>
                ...
                <li class="sitemap-link" >
                  <a href="https://crei.skoltech.ru/cdise" target="_blank"  title="CDISE">* Center for Computational and Data-Intensive Science and Engineering</a>
                </li>
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Organized by <a href="http://skoltech.ru">Skoltech</a>, <a href="http://mlss.cc">MLSS</a> and <a href="http://adase.group">ADASE</a>.</p> <p>Image header by Wassily Kandinsky</p>
          </section>
